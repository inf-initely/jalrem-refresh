                            ...
                            @foreach ($kerjasama as $k)
                                <div class="col-lg-4 mb-1">
                                    <div class="card no-border card-artikel">
                                        ...
                                        <a href="{{ route('kerjasama_detail', $k->slug_english ?? $k->slug) }}"
                                            class="stretched-link"></a>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="card no-border card-media">
                                    <div class="card-body row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <p class="des-card-info">The traces display the cultural interactions in the
                                                past</p>
                                        </div>
                                    </div>
                                ...
                                <div class="card no-border card-media">
                                    <div class="card-body row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <p class="des-card-info">A means of reconstruction and revitalization of the
                                                nautical cultural routes</p>
                                        </div>
                                    </div>
