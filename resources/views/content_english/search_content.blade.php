                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card no-border card-artikel">
                                        ...
                                        <a class="stretched-link lightbox"
                                            href="{{ route('video_detail', $a->slug_english ?? $a->slug) }}"></a>
                                        <div class="card-body">
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    ...
                                    <div
                                        ...
                                        <a href="#" title="" target="_blank"
                                            ...
                                            href="{{ route('audio_detail', $a->slug_english ?? $a->slug) }}"
                            ...
                            @else
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card no-border card-artikel">
                                        ...
                                        <a href="{{ route(generate_route_content($a->getTable()) . '_detail', $a->slug_english ?? $a->slug) }}"
