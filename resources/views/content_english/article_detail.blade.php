...
@section('title')
    {{ $artikel->judul_english ?? $artikel->judul_indo }} - Jalur Rempah Kemdikbudristek Republik Indonesia
@endsection
                        ...
                        <div class="col-lg-8 wrap-detail-artikel">
                            <header>
                                ...
                                <div class="info-penulis">
                                    <span class="txt-penulis" class="mr-3" id="penulis"
                                        name="penulis">{{ $artikel->penulis != 'admin' ? $artikel->kontributor_relasi->nama : 'admin' }}</span>
                                    |
                                    <span class="txt-penulis" id="tglArtikel"
                                        name="tglArtikel">{{ \Carbon\Carbon::parse($artikel->published_at)->isoFormat('D MMMM Y') }}</span>
                                </div>
                            </header>
                            <article id="isiKonten">
                                <img class="mb-3 mt-3"
                                    src="{{ asset('storage/assets/artikel/thumbnail/' . $artikel->thumbnail) }}"
                                    width="100%">
                            ...
                            @if ($artikelBacaJuga)
                                <div class="wrap-baca-juga">
                                    <p>Read: <a
                                            href="{{ route('article_detail', $artikelBacaJuga->slug_english ?? $artikelBacaJuga->slug) }}"
                                            class="berita-terkait">{{ $artikelBacaJuga->judul_english }}</a></p>
                                </div>
                            @endif
                        </div>
                        <div class="col-lg-4">
