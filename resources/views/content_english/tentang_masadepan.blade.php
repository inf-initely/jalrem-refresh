                        ...
                        <article class="col-lg-8">
                            ...
                            <section id="desTentang">
                                <p>
                                    ...
                                    cultural ecosystem—a means of <b>reconstruction and revitalization</b> through the sea
                                                                    ...
                                                                    @if ($a->rempahs != null)
                                                                        @foreach ($a->rempahs as $r)
                                                                            @if ($r->jenis_rempah_english)
                                                                                <a href="{{ route('rempah_detail', $r->jenis_rempah_english) }}"
                                                            ...
                                                            <div class="col-5 center-v">
                                                                ...
                                                                <div
                                                                    ...
                                                                    · <a href="{{ route('audio_detail', $a->slug) }}"
                                                                        title="{{ $a->judul_english }}"
                                                                        style="color: #cccccc; text-decoration: none;">{{ $a->judul_english }}</a>
                                                                </div>
                                                                <main></main>
                                                            </div>
                                                            <div class="col-7 center-v">
                                    ...
                                    <div class="card no-border card-media">
                                        <div class="card-body row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="des-card-info">The Spice Routes covers various cultural routes
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card no-border card-media">
                                        <div class="card-body row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="des-card-info">The traces display the cultural interactions in
                                                    the past</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card no-border card-media">
                                        <div class="card-body row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="des-card-info">A means of reconstruction and revitalization of
                                                    the nautical cultural routes</p>
                                            </div>
                                        </div>
