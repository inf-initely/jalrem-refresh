                                    ...
                                    <div class="container">
                                        <div data-swiper-parallax="300" class="slide-title">
                                            <h2 class="title"><a style="text-decoration: none; color: #fff;"
                                                    href="{{ route(generate_route_content($s->getTable()) . '_detail', $s->slug_english ?? $s->slug) }}">{{ $s->judul_english }}</a>
                                            </h2>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="slide-inner slide-bg-image" data-background="assets/img/hero/hero-1.jpg">
                                ...
                                <div class="container">
                                    ...
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p class="caption">Respecting the past through our heritage, enlivening the future
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center content-jelajahi" data-aos="fade-right">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 center-v">
                            ...
                            <p class="jelajah-des">The Spice Routes covers various cultural routes that gave rise to global
                                civilization & revive the people of Nusantara’s role centuries ago.</p>
                ...
                explore more
                    ...
                    <div class="row justify-content-center content-jelajahi wrap-div text-end" data-aos="fade-left">
                        <div class="col-12 col-md-6 col-lg-6 center-v mb-2 second-div sec-jejak">
                            ...
                            <p class="jelajah-des">The traces display the cultural interactions in the past that still exist
                                today, a cultural heritage that has become Indonesia’s collective memory.</p>
                ...
                explore more
                    ...
                    <div class="row justify-content-center content-jelajahi" data-aos="fade-right">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 center-v">
                            ...
                            <p class="jelajah-des">A means of reconstruction and revitalization of the nautical cultural
                                routes. Re-excavating the potentials for sustainable wealth and prosperity of all.</p>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center content-jelajahi" data-aos="fade-left">
                        ...
                        <div class=" col-lg-10 center-v">
                            ...
                            <p class="jelajah-des text-center">The cultural assimilation and its connectedness among nations
                                in Indonesia did not just happen. International traders played a significant role in the
                                cultural development that left the traces we can find today. It is due to the spice
                                commodity, coming from various islands in Nusantara that formed the trade traffic in the
                                past, and thus becoming a cultural route.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="artikelDanBerita">
                <section class="container" id="artikel">
                    <header class="row justify-content-center mb-2">
                        ...
                        <div class="col-md-6 center-v text-end  d-desktop">
                            <a href="{{ route('articles') }}" class="btn btn-outline-danger">See All News and
                                Articles</a>
                        </div>
                    </header>
                        ...
                        @foreach ($artikel as $a)
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card no-border card-artikel">
                                    ...
                                    <a href="{{ route('article_detail', $a->slug_english ?? $a->slug) }}"
                                        class="stretched-link"></a>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        <section class="col-md-6 center-v">
                            <header>
                                ...
                                <p class="des-sub-judul">Follow various exciting contents about the Spice Routes through
                                    the articles, photos, videos, and audio.</p>
                ...
                <div class="wrap-text-kontributor">
                    <div class="row">
                        <div class="col-lg-5 clr-white">
                            ...
                            <p>Support the Spice Routes' activities by contributing to the website. We welcome various
                                contents from contributors in the forms of articles, essays, coverage, photo stories, and
                                videos from historical, cultural, gastronomic, archaeological, literary, culinary, film,
                        ...
                        <div class="offset-lg-1 col-lg-6 text-center center-v">
                            <a href="{{ route('contributor') }}" class="btn btn-lg btn-secondary btn-primary-jarem">Join
                                Us</a>
                        </div>
                    </div>
                </div>
