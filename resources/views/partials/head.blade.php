    ...
    @if (Session::get('lg') == 'en')
        ...
        @if (Request::segment(1) == null)
            ...
            <meta name="description"
                content="The Spice Routes program aims to respect the past through heritage, enlivening the future for the well-being of all. ">
            <meta name="keywords"
                content="spices,spice routes,spice routes map,the spice routes,spice routes globalization,spice trade,spice trade routes">
            <!-- END HALAMAN HOME -->
        @elseif(Request::segment(1) == 'tentang-jalur')
            <!-- HALAMAN JALUR -->
            <meta name="title" content="Routes - The Spice Routes Indonesia">
            <meta name="description"
                content="The spice trade routes cover various cultural routes from one point to another that gave rise to global civilization">
            <meta name="keywords"
                content="trade routes,trade routes humankind,the trade routes,ancient routes,ancient trade routes">
            <!-- END HALAMAN JALUR -->
        @elseif(Request::segment(1) == 'tentang-jejak')
            <!-- HALAMAN JEJAK -->
            <meta name="title" content="The Traces of Spice Routes - Indonesia">
            <meta name="description"
                content="The traces of spice routes display the cultural interactions in the past that still exist today in various mediums.">
        ...
        @elseif(Request::segment(1) == 'tentang-masa-depan')
            ...
            <meta name="description"
                content="A means of reconstruction and revitalization through the sea as a symbol of wealth and prosperity.">
        ...
        @elseif(Request::segment(1) == 'konten')
            ...
            <meta name="description"
                content="Follow various exciting contents about the Spice Routes through the articles, photos, videos, and audio.">
        ...
        @elseif(Request::segment(1) == 'informasi')
            ...
            <meta name="description"
                content="Find out numerous information about the Spice Routes program from different areas in Indonesia, both online and offline.">
    ...
    @else
        ...
        @if (Request::segment(1) == null)
            ...
            <meta name="description"
                content="Program yang bertujuan melihat warisan rempah rempah masa lalu, menghidupkan masa depan, demi kesejahteraan bersama.">
            <meta name="keywords"
                content="rempah rempah,rempah rempah indonesia,rempah rempah adalah,jenis rempah rempah,manfaat rempah rempah">
            <!-- END HALAMAN HOME -->
        @elseif(Request::segment(1) == 'tentang-jalur')
            <!-- HALAMAN JALUR -->
            <meta name="title" content="Jalur Rempah Nusantara Kemdikbudristek Republik Indonesia">
            <meta name="description"
                content="Jalur Rempah mencakup jalur budaya yang melahirkan peradaban global & menghidupkan kembali peran masyarakat Nusantara.">
        ...
        @elseif(Request::segment(1) == 'tentang-jejak')
            ...
            <meta name="description"
                content="Jejak perdagangan rempah masa lalu memperlihatkan interaksi & peninggalan nilai budaya yang masih hidup hingga hari ini">
        ...
        @elseif(Request::segment(1) == 'tentang-masa-depan')
            ...
            <meta name="description"
                content="Sebuah upaya rekontruksi dan revitalisasi jalur budaya bahari. Penggalian kembali potensi masa depan Indonesia.">
        ...
        @elseif(Request::segment(1) == 'konten')
            ...
            <meta name="description"
                content="Simak berbagai konten menarik mengenai Jalur Rempah, seperti artikel, foto, video, audio, hingga publikasi.">
        ...
        @elseif(Request::segment(1) == 'informasi')
            ...
            <meta name="description"
                content="Simak informasi lengkap mengenai Jalur Rempah di berbagai wilayah di Indonesia secara daring & luring.">
