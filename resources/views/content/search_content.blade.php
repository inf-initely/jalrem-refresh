...
@section('content')
    <header id="hero">
        <img class="hero-img-2"
            srcset="assets/img/hero/hero-4-576px.webp 576w, assets/img/hero/hero-4-768px.webp 768w, assets/img/hero/hero-4-992px.webp 992w, assets/img/hero/hero-4-1200px.webp 1200w, assets/img/hero/hero-4.webp"
                    ...
                    <div class="row justify-content-center">
                        @foreach ($artikel as $a)
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    ...
                                    <div
                                        ...
                                        <a href="#" title="" target="_blank"
                                            ...
                                            href="{{ route('audio_detail', $a->slug) }}" title="{{ $a->judul_indo }}"
                                            style="color: #cccccc; text-decoration: none;">{{ $a->judul_indo }}</a></div>
                                    <main></main>
                                    @foreach ($a->kategori_show as $ks)
                                        @if ($ks->isi == 'Indepth')
                                            <span class="badge rounded-pill py-1 px-3 bg-success">Indepth</span>
                            ...
                            @else
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card no-border card-artikel">
                                        <img src="{{ asset(get_asset_path($a->getTable(), $a->thumbnail, 'thumbnail')) }}"
