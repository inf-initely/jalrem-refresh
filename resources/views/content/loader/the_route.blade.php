        ...
        for (const content of contents) {
                    ...
                    <div class="card no-border no-background">
                        <div class="card-body row">
                            ...
                            <div class="col-7 center-v">
                                <a href="#" class="text-danger m-0 p-0 text-decoration-none wilayah"><small>${content.location}</small></a>
            ...
            <div class="col-lg-6 mb-2">
                <div class="card no-border no-background">
                    <div class="card-body row">
                        <div class="col-5 center-v">
                            <img class="tentang-thumbnail" src="{{ asset('storage/assets/${content.table_name}/thumbnail/${content.thumbnail}') }}" width="100%">
                        </div>
                        <div class="col-7 center-v">
                            <a href="#" class="text-danger m-0 p-0 text-decoration-none wilayah"><small>${content.location}</small></a>
                            <h3 class="judul-artikel judul-artikel-tentang"><a href="${content.table_name}/${content.slug}" class="text-decoration-none clr-black">${content.title}</a> </h3>
                            <div class="wrap-tag-rempah">
                                ${spices}
                            </div>
                            ${categories}
