                            ...
                            <header>
                                ...
                                <div class="info-penulis">
                                    <span class="txt-penulis" class="mr-3" id="penulis"
                                        name="penulis">{{ $kegiatan->penulis != 'admin' ? $kegiatan->kontributor_relasi->nama : 'admin' }}</span>
                                    |
                                    <span class="txt-penulis" id="tglArtikel"
                                        name="tglArtikel">{{ \Carbon\Carbon::parse($kegiatan->published_at)->isoFormat('D MMMM Y') }}</span>
                                </div>
                            </header>
                            <img src="{{ asset('storage/assets/kegiatan/thumbnail/' . $kegiatan->thumbnail) }}"
                                width="100%">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 center-v">
                                                        <p class="tgl-kegiatan" id="tglKegiatan" name="tglKegiatan">
                                                            {{ $k->created_at->isoFormat('D MMMM Y') }}</p>
