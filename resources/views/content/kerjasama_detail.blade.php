...
@section('title')
    {{ $kerjasama->judul_indo }} - Jalur Rempah Kemdikbudristek Republik Indonesia
@endsection
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <article class="col-lg-8">
                            ...
                            <img class="mb-3 mt-3"
                                src="{{ asset('storage/assets/kerjasama/thumbnail/' . $kerjasama->thumbnail) }}"
                                width="100%">
                            <article id="txtMedia" class="mt-3">
                                {!! $kerjasama->konten_indo !!}
                            </article>
                            @if ($kerjasama->penulis != 'admin')
