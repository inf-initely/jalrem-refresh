        ...
        <div id="content">
            <div class="row">
                ...
                <div class="col-lg-5 wrap-form-daftar center-v">
                    <a href="index.html">
                        <img class="logo-daftar mb-4" src="{{ asset('assets/img/logo/logo-2.png') }}">
                    </a>
                    ...
                    <div class="card mt-5 mb-2">
                        <div class="card-body">
                            ...
                            <p class="des-form-daftar">Fill the username & password below. Captcha used for authenticate
                            ...
                            <form method="post" action="{{ route('login_post') }}">
                                ...
                                <div class="input-group mb-4">
                                    <span class="input-group-text icon-group" id="icon-email"> <i
                                            class="fa fa-envelope"></i> </span>
                                    <input value="{{ old('email') }}" id="inputEmail" type="email" name="email"
                                        class="form-control" placeholder="masukkan email" aria-label="email"
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input value="{{ old('password') }}" id="inputPassword" type="password"
                                        name="password" class="form-control" placeholder="masukkan password"
                                        aria-label="password" aria-describedby="icon-pass">
                                ...
                                <div class="form-group mt-4 mb-4">
                                    <div class="captcha" style="display: flex;">
                                        ...
                                        <span
                                            style="margin-left: 5px; margin-right: 5px;">{!! captcha_img() !!}</span>
