        ...
        <div id="content">
            <div class="row">
                ...
                <div class="col-lg-5 wrap-form-daftar center-v">
                            ...
                            <form method="post" action="{{ route('register_post') }}">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input id="inputEmail" type="email" class="form-control"
                                        placeholder="masukkan email" aria-label="email" name="email"
                                        aria-describedby="icon-email">
                                </div>
                                <div class="input-group mb-4">
                                    <span class="input-group-text icon-group" id="icon-tel"> <i
                                            class="fa fa-phone"></i> </span>
                                    <input id="inputTelpon" name="telp" type="tel" class="form-control"
                                        placeholder="masukkan no. telpon" aria-label="telpon"
                                        aria-describedby="icon-tel">
                                </div>
                                <div class="input-group mb-4">
                    ...
                    <p class="des-form-daftar text-center">Already hava an account? <a class="link-daftar"
