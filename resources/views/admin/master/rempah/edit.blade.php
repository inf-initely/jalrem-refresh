                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      <div class="mb-3">
                        ...
                        <input name="nama_rempah" value="{{ $rempah->jenis_rempah }}" type="text" class="form-control" id="namaRempah" placeholder="masukkan nama rempah">
                      </div>
                      <div class="mb-3">
                        <label for="keteranganRempah" class="form-label">Keterangan Rempah</label>
                        <textarea name="keterangan_rempah" class="form-control" id="isiArtikelBahasa" rows="8">{{ $rempah->keterangan }}</textarea>
