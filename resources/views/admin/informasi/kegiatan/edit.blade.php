                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class='col-lg-6'>
                        ...
                        <input required name="publish_date" value="{{ explode(" ", $kegiatan->created_at)[0] }}" type="date" class="form-control" id="tanggalPublish">
                      </div>
                      <div class='col-lg-6'>
                        <label for="waktuPublish" class="form-label">Waktu Publish</label>
                        <input required name="publish_time" value="{{ substr(explode(" ", $kegiatan->created_at)[1], 0,5) }}" type="time" class="form-control" id="waktuPublish">
                      </div>
                    </div>
                  </div>
                </div>
