...
<form method="POST" action="{{ route('admin.publication.update', $publikasi->id) }}" enctype="multipart/form-data">
  ...
  <div class="container-fluid" id="contentWrapper">
      ...
      <div class="row">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="meta_indo" class="form-control" id="metaDesID" rows="2" maxlength="160" placeholder="masukkan meta description">{{ $publikasi->meta_indo }}</textarea>
                  <little>maks 160 karakter</little>
                </div>
                <div class="mb-3">
                  <label for="keywordsID" class="form-label">Keywords</label>
                  <input value="{{ $publikasi->keywords_indo }}" name="keywords_indo" id="keywordsID" type="text" class="form-control tagin">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="meta_english" class="form-control" id="metaDesEN" rows="2" maxlength="160" placeholder="masukkan meta description">{{ $publikasi->meta_english }}</textarea>
                  <little>maks 160 karakter</little>
                </div>
                <div class="mb-3">
                  <label for="keywordsEN" class="form-label">Keywords</label>
                  <input value="{{ $publikasi->keywords_english }}" name="keywords_english" id="keywordsEN" type="text" class="form-control tagin" data-separator=",">
                  <little>gunakan tombol "," (koma) untuk memisahkan keyword</little>
                </div>
            </div>
          </div>
            ...
            <div class="card-body ">
              <div class="row">
                <div class="col-lg-12 text-center">
                  <img class="preview mb-3 text-center" src="{{ asset('storage/assets/publikasi/thumbnail/' . $publikasi->thumbnail) }}" />
                </div>
              </div>
              <div class="mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <div class="px-3 row">
                    <div class="col-lg-4">
                      <div class="form-check">
                        @if( $publikasi->penulis == 'kontributor umum/pamong budaya' )
            ...
            <div class="card-body ">
              <div class="row">
                <div class="col-lg-12 text-center">
                  ...
                  @else
                    <img class="preview mb-3 text-center" src="{{ asset('storage/assets/publikasi/slider/' . $publikasi->slider_file) }}" />
                  @endif
                </div>
              </div>
              <div class="mb-4">
        ...
        <div id="kontributor" class="col-lg-12 mb-3" style="display: {{ $publikasi->penulis == 'kontributor umum/pamong budaya' ? 'initial' : 'none' }};">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="mb-3">
                <label for="jenisKontributor" class="form-label">Jenis Kontributor</label>
                  <select name="contributor_type" class="form-select mb-4" aria-label="select kontributor">
                    @if( $publikasi->contributor == 'pamong budaya' )
                    ...
                    @elseif( $publikasi->contributor == 'umum' )
                      <option value="" selected>Jenis Kontributor</option>
              ...
              <div class="mb-3">
                ...
                <select id="namaKontributor" name="id_kontributor" class="form-select select2-style" aria-label="Default select example">
                  ...
                  @foreach( $kontributor as $k )
                    @if( $publikasi->id_kontributor )
                      @if( $k->id == $publikasi->kontributor_relasi->id )
