                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control editor" name="konten_indo" id="isiArtikelBahasa" rows="8"></textarea>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body ">
                  <div class="mb-3">
                    ...
                    <input type="text" name="youtube_key" class="form-control" id="youtubeKey" placeholder="masukkan youtube key">
