            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea required name="meta_indo" class="form-control" id="metaDesID" rows="2" maxlength="160" placeholder="masukkan meta description">{{ $artikel->meta_indo }}</textarea>
                    <little>maks 160 karakter</little>
                  </div>
                  <div class="mb-3">
                    <label for="keywordsID" class="form-label">Keywords</label>
                    <input required name="keywords_indo" value="{{ $artikel->keywords_indo }}" id="keywordsID" type="text" class="form-control tagin">
