    ...
    <form method="POST" action="{{ route('admin.audio.update', $audio->id) }}" enctype="multipart/form-data">
      ...
      <div class="container-fluid" id="contentWrapper">
        ...
        <div class="row">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="meta_indo" class="form-control" id="metaDesID" rows="2" maxlength="160" placeholder="masukkan meta description">{{ $audio->meta_indo }}</textarea>
                    <little>maks 160 karakter</little>
                  </div>
                  <div class="mb-3">
                    <label for="keywordsID" class="form-label">Keywords</label>
                    <input value="{{ $audio->keywords_indo }}" name="keywords_indo" id="keywordsID" type="text" class="form-control tagin">
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="px-3 row">
                      <div class="col-lg-4">
                        <div class="form-check">
                          @if( $audio->penulis == 'kontributor umum/pamong budaya' )
          ...
          <div id="fotoSlider" class="col-lg-12 mb-3" style="display: {{ $audio->slider_file != null ? 'initial' : 'none' }};">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
          ...
          <div id="kontributor" class="col-lg-12 mb-3" style="display: {{ $audio->penulis == 'kontributor umum/pamong budaya' ? 'initial' : 'none' }};">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                ...
                <div class="mb-3">
                  ...
                  <select id="namaKontributor" name="id_kontributor" class="form-select select2-style" aria-label="Default select example">
                    ...
                    @foreach( $kontributor as $k )
                      @if( $audio->id_kontributor )
                        @if( $k->id == $audio->kontributor_relasi->id )
              ...
              <div class="card-body">
                <div class="row">
                  <div class='col-lg-6'>
                    ...
                    <input required name="publish_date" value="{{ explode(" ", $audio->published_at)[0] }}" type="date" class="form-control" id="tanggalPublish">
                  </div>
                  <div class='col-lg-6'>
                    <label for="waktuPublish" class="form-label">Waktu Publish</label>
                    <input required name="publish_time" value="{{ substr(explode(" ", $audio->published_at)[1], 0,5) }}" type="time" class="form-control" id="waktuPublish">
                  </div>
                </div>
              </div>
            </div>
