                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="konten_indo" editor" id="isiArtikelBahasa" rows="8"></textarea>
                      </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body ">
                    ...
                    <div class="mb-4">
                      <input name="thumbnail" class="form-control" id="uploadThumbnail" type="file" data-preview=".preview">
                    </div>
                    <div class="mb-3">
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body row">
                    <div class="col-lg-6">
                      <input name="slider_foto[]" id="files" type="file" multiple />
                    </div>
